...
public class ResourceValidator implements ConstraintValidator<ResourceVaild, List<String>> {
    ...
    public boolean isValid(List<String> values, ConstraintValidatorContext context) {
        ...
        boolean isValid = TypeUtils.ALLOWED_TYPES.containsAll(values);
        ...
        if (!isValid) {
            ...
            context.buildConstraintViolationWithTemplate(ErrorCode.NOT_VALID_RESOURCE.getCode())
